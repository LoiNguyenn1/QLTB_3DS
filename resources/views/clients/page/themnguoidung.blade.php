            ...
            <div class="row">
                <div class="form-group">
                    <strong>Mã Thiết Bị</strong>
                            <input type="text" name="ma_thiet_bi" class="form-control" placeholder="Mã thiết bị">
                                @error('ma_thiet_bi')
                ...
                <div class="form-group">
                    <strong>Tên Máy</strong>
                        <input type="text" name="ten_may" class="form-control" placeholder="Tên máy" >
                            @error('ten_may')
                                <span style="color: red">{{$message}}</span>
                            @enderror
                </div>
                <div class="form-group">
                    <strong>Người Sử Dụng</strong>
                        <input type="text" name="nguoi_su_dung" class="form-control" placeholder="Người sử dụng">
                            @error('nguoi_su_dung')
                                    <span style="color: red">{{$message}}</span>
                            @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cau_hinh_may" class="form-control" placeholder="Cấu hình máy" >
                        @error('cau_hinh_may')
                            <span style="color: red">{{$message}}</span>
                        @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phong_ban" class="form-control" placeholder="Phòng ban">
                </div>
                        @error('phong_ban')
                            <span style="color: red">{{$message}}</span>
                        @enderror
